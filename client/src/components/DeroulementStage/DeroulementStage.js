...
import './DeroulementStage.css';

function DeroulementStage() {
	...
	return (
		<div className="DeroulementStage-Main">
			<div>
				<label>
					<input
						type="radio"
			...
			{type === "etudiant" && (<div>
				<h4>Édition {date} - Directives pour les étudiants</h4>
				<br />
				<p>Tâches à effectuer par l'étudiant à la session d'automne  (c'est-à-dire maintenant):</p>
				<br />
				<p>Au plus tard le mardi 18 septembre à 12h00: Produire un CV que vous devez remettre au coordonnateur des stages (Sylvain Labranche). </p>
				<br />
				<p>En format "Word" ou en format PDF que vous allez remettre sur Moodle pour le cours "2018-2019 : Stages de fin d'études en informatique".
					Vous devez remettre un seul fichier .ZIP (pas d'autre format accepté) nommé
					NomFamillePrenom.ZIP (pas d'espace, ni d'accent dans le nom du fichier)</p>
				<br />
				<p>Contacter les employeurs pour leur proposer vos services</p>
				<br />
				<p>Pour chaque employeur que vous contactez vous devez inscrire ses coordonnées sur le formulaire</p> <a href="../documents/contact_employeurs.pdf" />
				<br />
			...
			{type === "employeur" && (
				<p>
					<h4>Édition {date} - Directives pour les employeur</h4>
...
export default DeroulementStage;