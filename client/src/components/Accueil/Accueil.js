    ...
    return (
        <div className="accueil-container">
            <div className="accueil-header">
                <div className="accueil-header-title">
                    <h2>Bienvenue sur le site des stages de fin d'études des techniques de l'informatique du Collège Montmorency!</h2>
                </div>
                <img className="accueil-header-logo" src={"/images/Accueil.png"} alt='image'></img>
                <div className="accueil-header-subtitle">
                    <h3>À la fin de leurs études, les étudiants sont appelés à mettre en pratique les compétences acquises durant le programme. Cela se fait grâce à la participation d'entreprises de la région qui les accueillent afin de finaliser leurs formations.</h3>
                </div>
            </div>

            <div className="accueil-content">
                <div>
                    <div className='accueil-content-titre'>
                        <h1>Édition {date} </h1>
                    </div>
